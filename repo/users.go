...
func (d *Data) UserIndexes() {
	...
	for i := range d.Users {
		...
		d.UserIdx["ExternalID"][strings.ToLower(d.Users[i].ExternalID)] = append(d.UserIdx["ExternalID"][strings.ToLower(d.Users[i].ExternalID)], d.Users[i])
		...
		d.UserIdx["CreatedAt"][strings.ToLower(d.Users[i].CreatedAt)] = append(d.UserIdx["CreatedAt"][strings.ToLower(d.Users[i].CreatedAt)], d.Users[i])
		...
		d.UserIdx["LastLoginAt"][strings.ToLower(d.Users[i].LastLoginAt)] = append(d.UserIdx["LastLoginAt"][strings.ToLower(d.Users[i].LastLoginAt)], d.Users[i])
