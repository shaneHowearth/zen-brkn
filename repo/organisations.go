...
func (d *Data) OrganisationIndexes() {
	...
	for i := range d.Organisations {
		...
		d.OrgIdx["DomainNames"][strings.Join(d.Organisations[i].DomainNames, ",")] = append(d.OrgIdx["DomainNames"][strings.Join(d.Organisations[i].DomainNames, ",")], d.Organisations[i])
		...
		d.OrgIdx["Tags"][strings.Join(d.Organisations[i].Tags, ",")] = append(d.OrgIdx["Tags"][strings.Join(d.Organisations[i].Tags, ",")], d.Organisations[i])
	}
}
